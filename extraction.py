...
def main():
    ...
    # Шаг 3. Загружаем список корней из файла yellow-root.txt и формируем для каждого вариант
    # с заменой "ё" на "е"
    ...
    # Шаг 5. Загружаем список исключаемых слов из файла yellow-base.txt и удаляем их из результатов
    ...
    output_filename = f"{base_name}_extraction.txt"
